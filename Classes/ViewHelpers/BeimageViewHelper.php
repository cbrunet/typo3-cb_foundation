 ...
 * </output>
 */
class BeimageViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper {
	...
	public function render($src, $width = NULL, $height = NULL, $minWidth = NULL, $minHeight = NULL, $maxWidth = NULL, $maxHeight = NULL, $treatIdAsReference = FALSE) {
		...
		if (TYPO3_MODE === 'BE') {
			$imageSource = '/' . $imageSource; // <--- this is the only change to the original image view helper.
			$this->resetFrontendEnvironment();
		}
